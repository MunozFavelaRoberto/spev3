...
const getItem = async () => {
  ...
  data: {
    item: {
      id: 4,
      active: 1,
      created_at: "2025-08-06 17:07:14",
      updated_at: "2025-08-06 20:56:16",
      created_by_id: 1,
      updated_by_id: 1,
      ...
      avatar: "HVUQsNMhDS1od4Y5LVtGIsbxhcouwkc1ct6Dh3zzbKn.png",
      identification_proof: null,
      address_proof: null,
      branch_id: null,
      uiid: "U-0004",
      description: "Descripción de la empresa de prueba para el sistema SPE",
      created_by: {
        email: "samuel@svr.mx"
      },
      updated_by: {
...
const handleAction = async () => {
  ...
  try {
    ...
    const response = getRsp(await axios.post(endpoint, getFormData(payload), getHdrs(store.getAuth?.token, true)))
